...
path = '/home/susmitha/clf_recovery/models/tr_bl_net2/'

if not os.path.isdir(path+'test_results_3l_new'):
	os.mkdir(path+'test_results_3l_new')

path += 'test_results_3l_new/'
...
code = loadmat('randn_p15_cs1.mat')['fullCode']
...
model = 'models/tr_bl_net2/clf_iter_300000.caffemodel'
