	...
	if (it % test_interval == 0):
		...
		for i in range(test_iters):
			...
			if show_results and it%show_interval==0:
				...
				pred_disp = solver.test_nets[0].blobs['depth'].data[...]
				img_save(pred_disp[idxs],it,i*1,'cdepthPredict_')

				reconst_views = solver.test_nets[0].blobs['label_depth'].data[...]
				img_save(reconst_views[idxs],-1,i*1,'dGTdepth_')
