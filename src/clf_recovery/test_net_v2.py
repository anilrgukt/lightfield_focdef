...
path = '/home/susmitha/clf_recovery/models/view_synth5/'
...
proto = 'models/view_synth5/deploy.prototxt'
model = 'models/view_synth5/clf_iter_70000.caffemodel'
...
for img_name in img_list:
	...
	for viewLF in selLF:
		...
		np.save(path+str(count).zfill(3)+'_disparray', disp_reconst)
